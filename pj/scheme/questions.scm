...
(define (enumerate s)
  ; BEGIN PROBLEM 15
  (define (newlist lst index) (if (null? lst)nil ( append(list (list index (car lst)))( newlist (cdr lst) (+ index 1)))  )  )  
  (newlist s 0)
  )
  ; END PROBLEM 15
...
(define (merge comp list1 list2)
  ...
  (cond ((null? list1) list2)
  	((null? list2) list1)
	(else (if(comp (car list1) (car list2))(append (list(car list1))(merge comp (cdr list1) list2 )) (append(list(car list2))(merge comp list1 (cdr list2)) )))
)  )
  ; END PROBLEM 16
