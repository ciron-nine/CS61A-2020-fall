    ...
    if not feral_hogs:
        ...
        while score0<goal and score1<goal:
            if i%2==0:
                bonus=0
                times=strategy0(score0,score1)
                if times+2==prescore0 or times-2==prescore0:
                    bonus=3
                prescore0=take_turn(times,score1,dice)
                score0+=prescore0+bonus
                if is_swap(score0,score1):
                    temp=score0
                    score0=score1
                    score1=temp
                ...
                bonus=0
                times=strategy1(score1,score0)
                if times+2==prescore1 or times-2==prescore1:
                    bonus=3
                prescore1=take_turn(times,score0,dice)
                score1+=prescore1+bonus
                if is_swap(score1,score0):
                    temp=score0
                    score0=score1
                    score1=temp
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    # BEGIN PROBLEM 7
    "*** YOUR CODE HERE ***"
    def sub_highest(score0,score1,last_score=last_score,running_high=running_high):
        if who:
...
def make_averaged(original_function, trials_count=1000):
    ...
    # BEGIN PROBLEM 8
    "*** YOUR CODE HERE ***"
    def sub_aver(*args,times=trials_count):
        result=0
...
def swap_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    if is_swap(cur+score,opponent_score) and score+cur<opponent_score:
        return 0
    elif cur>=cutoff:
        if is_swap(cur+score,opponent_score):
            if cur+score<=opponent_score:
                return 0
        else:
            return 0
    return num_rolls  # Replace this statement
